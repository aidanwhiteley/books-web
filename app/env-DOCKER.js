...
(function (window) {
  ...
  window.__env.apiEndPoint = '/api';

  // Endpoint for secured API calls.
  // Can be relative path unless using CORS
  window.__env.secureApiEndPoint = '/secure/api';

  // Endpoint for feeds for list of recent changes.
  // Can be relative path unless using CORS
  window.__env.feedsEndPoint = '/feeds';
  ...
  // Can be relative path unless using CORS
  window.__env.logonGoogleEndPoint = '/login/google';

  // Application URL for starting a logon via Facebook.
  // Can be relative path unless using CORS
  window.__env.logonFacebookEndPoint = '/login/facebook';

  // The URL to initiate logout
  // Can be relative path unless using CORS
  window.__env.logoutEndPoint = "/secure/api/logout";

  // The URL for app metrics
  // Can be relative path unless using CORS. The trailing slash is important
  window.__env.appMetrics = "/actuator/";
  ...
  // The book club name
  window.__env.applicationName = 'The Docker Book Club';
  ...
  // Welcome / intro text
  window.__env.welcomeText = 'Welcome to The Docker Book Club!';
