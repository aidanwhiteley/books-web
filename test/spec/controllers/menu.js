...
(function () {
  ...
  describe('Controller: MenuCtrl', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, $log, $q, $httpBackend, booksConstants, userDataService, menuService, bookDataService) {
      ...
      // Returning dummy data for calls that arent part of the tests
      $httpBackend.when('GET', 'views/help.html').respond('');
      $httpBackend.when('GET', 'views/landing.html').respond('');
